  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        model: { type: "string", description: "Veo model/tier seçimi (isteğe bağlı). Ya bir tier adı — 'economy'/'veo-lite' (Veo 3.1 Lite, en ucuz), 'fast'/'veo-fast' (Veo 3.1 Fast), 'quality'/'veo-generate' (Veo 3.1 Generate, en pahalı/yavaş, en yüksek kalite), 'auto' (VEO_DEFAULT_TIER'a, o da yoksa economy'ye düşer) — ya da doğrudan tam model adı (ör. 'veo-3.1-generate-preview', geriye dönük uyumluluk için hâlâ kabul edilir). Verilmezse VEO_VIDEO_MODEL/VEO_DEFAULT_TIER env değişkenlerine, onlar da yoksa economy'ye düşülür. Seçilen model/tier ASLA başka birine sessizce düşürülmez — geçersiz bir isim hemen hata verir. Seçilen model 429 (kota) hatası verirse yanıttaki 'alternatives' alanında önerilen diğer tier'lar listelenir — bu tool onlara ASLA otomatik geçmez, açıkça yeni bir model ile confirmed:true göndermeniz gerekir." },
