  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        model: { type: "string", description: "Veo model/tier seçimi (isteğe bağlı). ÖNEMLİ: Veo 3 (GA) ve Veo 3.1 (Preview) İKİ AYRI model ailesidir, birbirinin eşanlamlısı DEĞİLDİR — bir aile seçildiğinde diğerine ASLA sessizce geçilmez. Veo 3.1 (Preview, bu depodaki varsayılan aile): 'economy'/'veo-3.1-lite' (Lite, en ucuz — varsayılan), 'fast'/'veo-3.1-fast', 'quality'/'veo-3.1-generate' (en pahalı/yavaş, en yüksek kalite). Veo 3 (GA, resmi olarak dokümante edilmiş canonical ID'ler): 'veo-3-generate' (veo-3.0-generate-001), 'veo-3-fast' (veo-3.0-fast-generate-001). 'veo-3-lite' KASITLI OLARAK yok — Google'ın \"Lite\" tier'ı yalnızca Veo 3.1'de var; hesabınızda gerçekten bir \"Veo 3 Lite\" görüyorsanız gerçek ID'yi VEO_3_LITE_MODEL_ID ortam değişkenine tanımlayın, kod bunu tahmin etmez. 'auto' (VEO_DEFAULT_TIER'a, o da yoksa economy'ye düşer) veya doğrudan tam bir model adı (ör. 'veo-3.1-generate-preview', 'veo-3.0-generate-001') da kabul edilir. Verilmezse VEO_VIDEO_MODEL/VEO_DEFAULT_TIER env değişkenlerine, onlar da yoksa economy'ye düşülür. Seçilen model/tier/aile ASLA başka birine sessizce düşürülmez — geçersiz bir isim hemen hata verir. Seçilen model 429 (kota) hatası verirse yanıttaki 'alternatives' alanında AYNI AİLE İÇİNDEKİ diğer tier'lar listelenir (Veo 3 başarısız olursa Veo 3.1 hiç önerilmez) — bu tool onlara ASLA otomatik geçmez, açıkça yeni bir model ile confirmed:true göndermeniz gerekir." },
